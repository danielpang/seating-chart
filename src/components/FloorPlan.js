    ...
    return (
      <div className="w-full bg-white dark:bg-gray-800 rounded-xl p-6 shadow-inner">
        <div className="aspect-1 relative">
          ...
          >
            {/* Background */}
            <rect x="0" y="0" width="1120" height="640" className="fill-gray-50 dark:fill-gray-900" />

            {/* Entrance */}
            <rect x="510" y="580" width="100" height="40" className="fill-gray-300 dark:fill-gray-600" />
            <text x="560" y="605" className="text-lg fill-gray-600 dark:fill-gray-300 text-center" textAnchor="middle">Entrance</text>

            {/* Center aisle indicators */}
            <line x1="560" y1="580" x2="560" y2="540" className="stroke-gray-300 dark:stroke-gray-600" strokeWidth="3" strokeDasharray="6" />
            ...
            {/* Legend */}
            <text x="800" y="610" className="text-base fill-gray-500 dark:fill-gray-400">Round tables seat 8 people each</text>
          </svg>
        </div>
      </div>
    );
